"use strict";(self.webpackChunkuntitled_4=self.webpackChunkuntitled_4||[]).push([[5008],{89616:(rt,U,s)=>{s.d(U,{U:()=>W});var t=s(19968),p=s(5596),_=s(5e3),V=s(6912),E=s(48936),k=s(63358);const S=(0,p.cp)(_.k)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
